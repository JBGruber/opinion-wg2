### Script for abstract coding - reliability, sample for coding, results of coding ###
...
#write.csv2(abstracts_sample_daniel, "coding_1_daniel.csv", row.names = F)
#write.csv2(abstracts_sample_valerie, "coding_1_valerie.csv", row.names = F)
#write.csv2(abstracts_sample_roksana, "coding_1_roksana.csv", row.names = F)
#write.csv2(abstracts_sample_samia, "coding_1_samia.csv", row.names = F)
#write.csv2(abstracts_sample_sjoerd, "coding_1_sjoerd.csv", row.names = F)
#write.csv2(abstracts_sample_sasha, "coding_1_sasha.csv", row.names = F)

#save working space, see here: https://drive.google.com/drive/folders/1KSkZW_IoIAjcSiaTGmjHdhZetNV41_l6?usp=drive_link
#save.image("abstract_coding.RDATA")